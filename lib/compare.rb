...
module Compare
  ...
  class Group
    ...
    def retrieve_include_stat_keys
      stat_key_res = @comparer.include_stat_keys
      return [] unless stat_key_res

      do_filter_stat_keys retrieve_all_stat_keys, stat_key_res
    end
    ...
    def retrieve_include_all_failure_stat_keys
      return [] unless @comparer.include_all_failure_stat_keys

      retrieve_all_stat_keys.select { |stat_key| function_stat?(stat_key) }
    end
    ...
    def retrieve_testcase_stat_keys
      do_filter_testcase_stat_keys retrieve_all_stat_keys
    end
    ...
    def calc_changed_stat_keys(matrixes_in)
      stat_keys = if @comparer.use_all_stat_keys
                    retrieve_all_stat_keys
                  elsif @comparer.use_stat_keys
                    @comparer.use_stat_keys
                  elsif @comparer.use_testcase_stat_keys
                    retrieve_testcase_stat_keys
                  else
                    _calc_changed_stat_keys(matrixes_in)
                  end
      stat_keys |= retrieve_include_stat_keys
      stat_keys |= retrieve_include_all_failure_stat_keys
